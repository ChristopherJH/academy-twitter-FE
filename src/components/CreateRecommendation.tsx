...
export default function CreateRecommendation(props: CreateRecommendationProps): JSX.Element {
    return (
        <>
                        ...
                        <div className="modal-dialog modal-lg" role="document">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h5 className="modal-title" id="exampleModalLabel">Create a recommendation</h5>
    ...
    return (
        <form>
            <div className="form-group">
                ...
                <input type="text"
                    placeholder="Resource title" className="form-control" id="resource-name" />
                <input type="text"
                    placeholder="Author/Company name" className="form-control" id="author-name" />
                <input type="text"
                    placeholder="URL" className="form-control" id="url" />
                ...
                <textarea className="form-control" id="resource-description" rows={3} placeholder="Description of resource"></textarea>
            </div>
            <div className="form-group">
                ...
                <input type="text"
                    placeholder="Add a new tag" className="form-control" id="new-tags" />
            </div>
            ...
            <div className="form-group">
                ...
                <input type="text"
                    placeholder="Why recommended (or not)" className="form-control" id="why-recommended" />
